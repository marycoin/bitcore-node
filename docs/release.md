...
Binaries for marycoind are distributed for convenience and built deterministically with Gitian, signatures for marycoind are located at the [gitian.sigs](https://github.com/bitpay/gitian.sigs) respository.
